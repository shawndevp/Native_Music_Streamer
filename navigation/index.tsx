...
import TabFourScreen from '../screens/PremiumScreen';
  ...
  return (
    <BottomTab.Navigator
      ...
      />
        ...
        options={{
          title: 'Your Library',
          tabBarIcon: ({ color }) => <MaterialCommunityIcons name="music-box-outline" size={30} style={{ marginBottom: -3 }} color={color} />,
        }}
      />
                  <BottomTab.Screen
        name="TabFour"
